...
client.on('messageReactionAdd', function (reaction, _user) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!reaction.partial) return [3, 4];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, reaction.fetch()];
            case 2:
                _a.sent();
                return [3, 4];
            case 3:
                error_1 = _a.sent();
                console.log('Something went wrong when fetching the message: ', error_1);
                return [2];
            case 4:
