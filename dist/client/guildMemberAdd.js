...
exports.GuildMemberAdd = function (client, member) {
    ...
    var firstLine = "<@!" + ((_a = member.user) === null || _a === void 0 ? void 0 : _a.id) + "> \u307E\u305A\u306F <#" + throw_env_1["default"]('POLICY_CHANNEL_ID') + "> \u3092\u78BA\u8A8D\u3057\u306A\u3055\u3044\uFF01";
    var secondLine = "\u3061\u3083\u3093\u3068 <#" + throw_env_1["default"]('SELF_INTRODUCTION_ID') + "> \u3082\u66F8\u304F\u3053\u3068\u306D";
