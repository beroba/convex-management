...
exports.GuildMemberAdd = function (member) {
    ...
    channel.send("<@!" + ((_a = member.user) === null || _a === void 0 ? void 0 : _a.id) + "> \u307E\u305A\u306F <#" + const_settings_1["default"].WELCOME_CHANNEL.POLICY_ID + "> \u3092\u78BA\u8A8D\u3057\u306A\u3055\u3044\uFF01\n" +
        ("\u3061\u3083\u3093\u3068 <#" + const_settings_1["default"].WELCOME_CHANNEL.INTRODUCTION_ID + "> \u3082\u66F8\u304F\u3053\u3068\u306D"));
