...
**ボスを倒した場合は必ず先頭に<img src="../assets/kill.svg"/>を付けて下さい。**  
...
他人が見た時にひと目で分かるように順番を守り、スペースを入れて下さい。  
正確に凸状況を保存できないので、**ボスを倒した場合は必ず先頭に<img src="../assets/kill.svg"/>を付けて下さい。**  
...
**必ずボス名ではなく<img src="../assets/boss.svg"/>を入力して下さい。**  
