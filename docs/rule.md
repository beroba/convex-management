...
**必ず<img src="../assets/Imitation.svg"/>を済ましてから凸報告**して下さい。  
...
進行の妨げになるので**先に<img src="../assets/Imitation.svg"/>**を済ましてから凸宣言をして下さい。  
...
**ボスを倒した場合は必ず先頭に<a><img src="../assets/kill.svg"/></a>を付けて下さい。**  
...
他人が見た時にひと目で分かるように順番を守り、スペースを入れて下さい。  
正確に凸状況を保存できないので、**ボスを倒した場合は必ず先頭に<a><img src="../assets/kill.svg"/></a>を付けて下さい。**  
...
**必ずボス名ではなく<a><img src="../assets/boss.svg"/></a>を入力して下さい。**  
...
1ボスが`a`、2ボスが`b`、3ボスが`c`、4ボスが`d`、5ボスが`e`になっています。  
**ボス名や略称だと凸予約がされません、必ず<a><img src="../assets/boss.svg"/></a>を入力して下さい。**  
