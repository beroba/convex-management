...
## 目次
 - [クラバトに関するコマンド説明](#クラバトに関するコマンド説明)
   - [指定した人の凸状況を変更する `/cb convex {プレイヤーid} {凸数,持ち越し状況}`](#指定した人の凸状況を変更する-cb-convex-プレイヤーid-凸数持ち越し状況)
...
## 指定した人の凸状況を変更する。 `/cb convex {プレイヤーid} {凸数,持ち越し状況}`
...
`/cb convex 341239349997993984 3,1`の場合、`厚木下着まざらし, 3凸目 持ち越し`
